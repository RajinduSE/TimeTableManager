 ...
 * @author Rajindu's PC
 */
public class LecturerTimeTableController implements Initializable {
    ...
    private void changeLecturer(ActionEvent event) {
        ...
        if(!lecturer.equals("Select Lecturer")){
            cbLecturer.setDisable(true);
        }
    }
    ...
    private void generate(ActionEvent event) {
        for(int i = 1; i <= 5; i++){
            ...
            for(int j = 1; j <= 9; j++){
                ...
                String matchSession = getMatchSession(lecturer, sessionList);
    ...
    private String getMatchSession(String lecturer, ObservableList<String> sessionList) {
        String output = "";
